...
CREATE TABLE `PAGAMENTO` (
  `documento_pagamento` int(255) unsigned NOT NULL DEFAULT '0',
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PESSOA` (
  `cpf` int(20) unsigned NOT NULL DEFAULT '0',
  `nome` varchar(255) NOT NULL,
  PRIMARY KEY (`cpf`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PESSOA_PAG` (
  `cpf_pessoa` int(20) unsigned NOT NULL DEFAULT '0',
  `doc_pag` int(255) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `PROG_ACAO` (
  ...
  `cod_acao` int(255) unsigned NOT NULL DEFAULT '0',
